...
async def on_message_delete(message):
    ...
    if message.author.id != client.user.id:
        ...
        embed.add_field(name="**Deleted message in: **<#"+str(message.channel.id)+">" , value=str(message.content), inline=False)
        embed.set_author(name=str(message.author), icon_url=str(message.author.avatar_url))
        embed.set_footer(text="Deleted message at "+now.strftime("%Y/%m/%d %H:%M:%S"))
